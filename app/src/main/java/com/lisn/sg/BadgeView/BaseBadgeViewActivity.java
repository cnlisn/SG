...
public class BaseBadgeViewActivity extends AppCompatActivity {
    ...
    private void selectorColor(final OnColorClickListener l) {
        ...
        gv.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View v = new View(BaseBadgeViewActivity.this);
                ...
                WindowManager wm = (WindowManager) BaseBadgeViewActivity.this
