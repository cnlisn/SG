package com.lisn.circleprogressview;
...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        location = array.getInt(R.styleable.CircleProgressView_location, 1); //加载进度的开始位置
        mPaintWidth = array.getDimension(R.styleable.CircleProgressView_progress_paint_width, dip2px(context, 4));//默认4dp 画笔宽度
        mPaintColor = array.getColor(R.styleable.CircleProgressView_progress_paint_color, mPaintColor); //画笔颜色
        mTextSize = array.getDimension(R.styleable.CircleProgressView_progress_text_size, dip2px(context, 18));//默认18sp 文字尺寸
        mTextColor = array.getColor(R.styleable.CircleProgressView_progress_text_color, mTextColor); //文字颜色
        array.recycle();
